...
NOTE: Loot tokens and treasure chests are _not_ overlays and are defined in their own section.
...
Loot tokens and treasure chests are defined with the `loot` attribute.
