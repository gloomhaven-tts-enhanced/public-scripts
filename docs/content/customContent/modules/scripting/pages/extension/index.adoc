...
E.g. when a player clicks on the level checkmark on their character sheet, an `onCharacterChangeLevel` event is created.
...
[source,lua]
----
include::example$extension/extensionApi.lua[]
----
