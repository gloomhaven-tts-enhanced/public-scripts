...
At the top right of the screen is a small drop-down prompt.
Clicking on this will bring down the menu for the various Interface Panels.
At the bottom is the selection for Options.
