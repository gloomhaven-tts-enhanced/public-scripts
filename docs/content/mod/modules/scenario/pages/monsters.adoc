...
Alternatively there's also a menu for this in the Enemy Interface, as well as a xref:engine:feature/hotkeys.adoc#_draw_monster_attack_modifier[Game Key].
