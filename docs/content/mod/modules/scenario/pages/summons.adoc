...
The same can be achieved when using the xref:engine:feature/contextMenu.adoc[Context Menu] on a character that has a summon ability card. The summon will show up in the Context Menu and spawn above the character's head when spawned.
